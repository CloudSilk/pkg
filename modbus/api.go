...
type Client interface {
	...
	ReadWrite(slaveID byte, funcCode byte, data []byte) (results []byte, err error)
	ReadWriteWithSubFuncCode(slaveID byte, funcCode, subFuncCode byte, data []byte) (results []byte, err error)
}
