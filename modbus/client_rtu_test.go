...
func TestRTUClientProvider_encodeRTUFrame(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := tt.rtu.encodeRTUFrame(tt.args.slaveID, tt.args.pdu, CRCModbus16, false)
...
func TestRTUClientProvider_decodeRTUFrame(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			gotslaveID, gotpdu, err := decodeRTUFrame(tt.args.adu, CRCModbus16, false)
			if (err != nil) != tt.wantErr {
...
func BenchmarkRTUClientProvider_encodeRTUFrame(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		_, err := p.encodeRTUFrame(10, pdu, CRCModbus16, false)
		if err != nil {
			b.Fatal(err)
		}
	}
...
func BenchmarkRTUClientProvider_decodeRTUFrame(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		_, _, err := decodeRTUFrame(adu, CRCModbus16, false)
		if err != nil {
			b.Fatal(err)
		}
	}
